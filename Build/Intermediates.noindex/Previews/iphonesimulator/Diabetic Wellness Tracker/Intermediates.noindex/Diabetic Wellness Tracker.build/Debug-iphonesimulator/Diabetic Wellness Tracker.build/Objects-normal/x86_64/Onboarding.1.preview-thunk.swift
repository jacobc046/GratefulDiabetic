...
extension Onboarding {
    @_dynamicReplacement(for: setUserDefaults()) private func __preview__setUserDefaults() {
        ...
        UserDefaults.standard.set(__designTimeBoolean("#7981.[4].[7].[2].modifier[0].arg[0].value", fallback: true), forKey: kIsLoggedIn)
...
extension Onboarding {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        NavigationStack {
            Text(__designTimeString("#7981.[4].[5].property.[0].[0].arg[0].value.[0].arg[0].value", fallback: "Welcome to the diabetic wellness app"))
                .font(.largeTitle)
            ...
            ZStack {
                ...
                Text(__designTimeString("#7981.[4].[5].property.[0].[0].arg[0].value.[1].arg[0].value.[1].arg[0].value", fallback: "logo here"))
            }
            
            TextField(__designTimeString("#7981.[4].[5].property.[0].[0].arg[0].value.[2].arg[0].value", fallback: "First Name"), text: $firstName)
                .font(.title)
                .textFieldStyle(.roundedBorder)
                .padding()
                .textInputAutocapitalization(.words)
            TextField(__designTimeString("#7981.[4].[5].property.[0].[0].arg[0].value.[3].arg[0].value", fallback: "Last Name"), text: $lastName)
                .font(.title)
                .textFieldStyle(.roundedBorder)
                .padding()
                .textInputAutocapitalization(.words)
            ...
            Button {
                ...
                Text(__designTimeString("#7981.[4].[5].property.[0].[0].arg[0].value.[4].arg[1].value.[0].arg[0].value", fallback: "Submit"))
                    .foregroundStyle(fieldsAreComplete ? .black : .white)
                    .font(.title2)
            }
            .alert(__designTimeString("#7981.[4].[5].property.[0].[0].arg[0].value.[4].modifier[0].arg[0].value", fallback: "One or more fields are empty"), isPresented: $showAlert, actions: {})
            ...
            .clipShape(RoundedRectangle(cornerRadius: __designTimeFloat("#7981.[4].[5].property.[0].[0].arg[0].value.[4].modifier[3].arg[0].value.arg[0].value", fallback: 10.0)))
            .padding()
