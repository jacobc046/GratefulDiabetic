...
extension ComponentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        .padding()
        .frame(width: __designTimeInteger("#14032.[1].[2].property.[0].[0].modifier[1].arg[0].value", fallback: 350), alignment: .topLeading)
        .background(.regularMaterial)
        .clipShape(RoundedRectangle(cornerRadius: __designTimeInteger("#14032.[1].[2].property.[0].[0].modifier[3].arg[0].value.arg[0].value", fallback: 10)))
