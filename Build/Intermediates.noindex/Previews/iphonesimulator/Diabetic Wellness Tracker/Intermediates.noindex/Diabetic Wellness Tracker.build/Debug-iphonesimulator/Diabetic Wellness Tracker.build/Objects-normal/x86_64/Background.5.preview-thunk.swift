...
extension Background {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        __designTimeSelection(LinearGradient(colors: [.primary1, .primary1.opacity(__designTimeFloat("#13626.[1].[0].property.[0].[0].arg[0].value.[1].modifier[0].arg[0].value", fallback: 0.5))],
                       startPoint: .top, endPoint: .bottom)
        .ignoresSafeArea(), "#13626.[1].[0].property.[0].[0]")
