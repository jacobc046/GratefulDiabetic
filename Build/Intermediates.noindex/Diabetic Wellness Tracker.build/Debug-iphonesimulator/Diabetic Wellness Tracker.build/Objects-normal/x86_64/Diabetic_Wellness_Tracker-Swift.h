...
#ifndef DIABETIC_WELLNESS_TRACKER_SWIFT_H
#define DIABETIC_WELLNESS_TRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Diabetic_Wellness_Tracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("FeaturedRecipeEntity")
@interface FeaturedRecipeEntity : NSManagedObject
